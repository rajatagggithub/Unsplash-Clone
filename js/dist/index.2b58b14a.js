...
function appendImageToGallery(response) {
    ...
    response.forEach(function(e, currentIndex) {
        ...
        imageContainer.addEventListener("click", function() {
            ...
            if (e.location.city == null && e.location.country == null) imageLocation.style.display = "none";
            else if (e.location.city != null && e.location.country != null) imageLocationText.innerHTML = `${e.location.city}, ${e.location.country}`;
            else if (e.location != null) imageLocationText.innerHTML = `${e.location.country}`;
            if (e.views != 0) imageViewsValue.innerHTML = `${e.views}`;
            else imageViews.style.display = "none";
            imageDownloadsValue.innerHTML = `${e.downloads}`;
            imageLikes.innerHTML = `${e.likes}`;
            if (e.alt_description != null) imageDescriptionText.innerHTML = e.alt_description;
            else imageDescription.style.display = "none";
            if (e.exif.name != null) imageCameraText.innerHTML = e.exif.name;
            else imageCamera.style.display = "none";
    ...
    if (imagesInsideGallery.length < 5) document.querySelector(".gallery").style.columns = 2;
}
nextButton.addEventListener("click", function() {
    if (index < allImages.length - 1) {
        ...
        imageLikes.style.display = "flex";
        imageDescription.style.display = "flex";
        if (allImages[index + 1].location.city == null && allImages[index + 1].location.country == null) imageLocation.style.display = "none";
        else if (allImages[index + 1].location.city != null && allImages[index + 1].location.country != null) imageLocationText.innerHTML = `${allImages[index + 1].location.city}, ${allImages[index + 1].location.country}`;
        else if (allImages[index + 1].location != null) imageLocationText.innerHTML = `${allImages[index + 1].location.country}`;
        if (allImages[index + 1].views != 0) imageViewsValue.innerHTML = allImages[index + 1].views;
        else imageViews.style.display = "none";
        imageDownloadsValue.innerHTML = `${allImages[index + 1].downloads}`;
        imageLikes.innerHTML = `${allImages[index + 1].likes}`;
        if (allImages[index + 1].alt_description != null) imageDescriptionText.innerHTML = allImages[index + 1].alt_description;
        else imageDescription.style.display = "none";
        if (allImages[index + 1].exif.name != null) imageCameraText.innerHTML = allImages[index + 1].exif.name;
        else imageCamera.style.display = "none";
        index++;
    }
});
...
//# sourceMappingURL=index.2b58b14a.js.map
